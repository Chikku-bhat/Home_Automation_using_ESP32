        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
           ...
           /* //for GPIO13
            ...
            // Web Page Heading
            client.println("<body><h1>Smart Home Server</h1>");
            
           
            
            
            // Display current state, and ON/OFF buttons for GPIO 12  
            client.println("<p>Living Room Light - State " + output12State + "</p>");
            ...
            client.println("<p>Living Room Fan - State " + output27State + "</p>");
...
*/            
    ...
    // Display current state, and ON/OFF buttons for GPIO 14  
            client.println("<p>Bedroom Light - State " + output14State + "</p>");
